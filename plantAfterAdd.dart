...
import 'logIn.dart';
import 'plantBeforeAdd.dart';
import 'package:flutter/gestures.dart';
import 'package:page_transition/page_transition.dart';


class plantAfterAdd extends StatefulWidget {
  plantAfterAdd({
    Key key,
  }) : super(key: key);

  @override
  _plantAfterAddState createState() => _plantAfterAddState();
}

class _plantAfterAddState extends State<plantAfterAdd> {
  @override
        ...
        children: <Widget>[
                            ...
                            children: <Widget>[
                              Pinned.fromSize(
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Pinned.fromSize(
                                      bounds: Rect.fromLTWH(0.0, 0.0, 100, 100),
                                      size: Size(89.6, 87.1),
                                      pinLeft: true,
                                      pinRight: true,
                                      pinTop: true,
          ...
          Transform.translate(
            ...
            child: Container(
              width: 200,
              height: 240,
              child: Image.network(second.image),
            ),
          ),
          Transform.translate(
